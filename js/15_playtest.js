...
for (var i = 0; i < totalCollectables; i++) {
    ...
    collectables[i].y = Math.random() * 600;
...
backgroundImage.src = "images/BackgroundPixel2.png";
...
if(goalx == 0){
    ...
    window.open("00_hardMode.html", "_self");
}
